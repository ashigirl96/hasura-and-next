...
const Component: NextPage = () => {
  const [setRef, visible] = useIntersection({ rootMargin: '250px', disabled: true })
  return <div ref={setRef}>{visible ? <Box>Hello</Box> : <LoadingSkeltion />}</div>
}
